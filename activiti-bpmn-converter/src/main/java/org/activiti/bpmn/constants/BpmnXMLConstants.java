...
public interface BpmnXMLConstants {
  ...
  // custom add task properties
  public static final String ELEMENT_FIELD_ONE = "fieldOne";
  public static final String ELEMENT_FIELD_TWO = "fieldTwo";

  // fake element for mail task
  public static final String ELEMENT_TASK_MAIL = "mailTask";
  
  // custom add task 
  public static final String ELEMENT_TASK_CUSTOM_ADD = "customAddTask";
