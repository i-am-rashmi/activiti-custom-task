...
public class ServiceTaskJsonConverter extends BaseBpmnJsonConverter implements DecisionTableKeyAwareConverter {
  ...
  protected void convertElementToJson(ObjectNode propertiesNode, BaseElement baseElement) {
    ...
    else if ("custom_add".equalsIgnoreCase(serviceTask.getType())) {
        setPropertyFieldValue(PROPERTY_ADDTASK_FIELD_ONE, serviceTask, propertiesNode);
        setPropertyFieldValue(PROPERTY_ADDTASK_FIELD_TWO, serviceTask, propertiesNode);
