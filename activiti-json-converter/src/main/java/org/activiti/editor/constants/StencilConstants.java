...
public interface StencilConstants {
  ...
  /* custom add stencil parameters*/
  final String STENCIL_TASK_CUSTOM_ADD = "CustomAddTask";
  ...
  // Custom Add field properties
  
  final String PROPERTY_ADDTASK_FIELD_ONE = "custom_field_one_package";
  final String PROPERTY_ADDTASK_FIELD_TWO = "custom_field_two_package";
