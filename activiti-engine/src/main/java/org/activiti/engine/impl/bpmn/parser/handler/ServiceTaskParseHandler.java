...
public class ServiceTaskParseHandler extends AbstractActivityBpmnParseHandler<ServiceTask> {
  ...
  protected void createActivityBehaviorForServiceTaskType(BpmnParse bpmnParse, ServiceTask serviceTask) {
    ...
    } else if (serviceTask.getType().equalsIgnoreCase("add")) {
    	createCustomAddActivityBehaviour(bpmnParse, serviceTask);
    }
    else {
  ...
  protected void createCustomAddActivityBehaviour(BpmnParse bpmnParse, ServiceTask serviceTask) {
	    serviceTask.setBehavior(bpmnParse.getActivityBehaviorFactory().createCustomAddActivityBehaviour(serviceTask));
	  }
