...
import org.activiti.engine.impl.bpmn.behavior.CustomAddActivityBehaviour;
...
public class DefaultActivityBehaviorFactory extends AbstractBehaviorFactory implements ActivityBehaviorFactory {
	...
	public CustomAddActivityBehaviour createCustomAddActivityBehaviour(ServiceTask serviceTask) {
		return createCustomAddActivityBehaviour(serviceTask.getId(), serviceTask.getFieldExtensions());
	}


private CustomAddActivityBehaviour createCustomAddActivityBehaviour(String id,
			List<FieldExtension> fields) {
	List<FieldDeclaration> fieldDeclarations = createFieldDeclarations(fields);
    return (CustomAddActivityBehaviour) ClassDelegate.defaultInstantiateDelegate(
    		CustomAddActivityBehaviour.class,
            fieldDeclarations);
	}
